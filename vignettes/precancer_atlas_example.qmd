...
spec <- init_shinyTreelabel(sce, 
                    ...
                    de_test = "limma")
system.time(
  precalc_res <- precalculate_results(spec, sce, dbfile = "~/Downloads/result_cache/cd4.duckdb", output = c("da", "de", "de_meta"))
)
...
spec <- readRDS("~/shinyTreelabel_data/cd4-spec.RDS")
run_shinyTreelabel(spec, precalc_results = "~/shinyTreelabel_data/cd4.duckdb", 
