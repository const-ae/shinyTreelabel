...
```{r}
system.time(
  precalc_res <- precalculate_results(spec, sce, dbfile = "~/Downloads/result_cache/atlas_small.duckdb", output = c(""))
)
...
run_shinyTreelabel(spec, sce, precalc_results = "~/Downloads/result_cache/atlas_small.duckdb")
